...
{
    public class CountriesRestService: BaseRestService, ICountriesService
    {
        public CountriesRestService(string accessToken, string accessTokenType)
            : base(accessToken, accessTokenType)
        {

        }

        public async Task<CountriesResponse> GetCountries()
        {
            CountriesResponse userInfoResponse = new()
            {
            ...
            var requestUri = $"{API_ENDPOINT}{COUNTRIES_ENDPOINT}";
            ...
            if (Xamarin.Essentials.Connectivity.NetworkAccess == Xamarin.Essentials.NetworkAccess.Internet)
            {
                try
                {
                    ...
                    if (httpResponse.IsSuccessStatusCode)
                    {
                        ...
                        userInfoResponse.Countries = JsonConvert.DeserializeObject<IEnumerable<Country>>(await httpResponse.Content.ReadAsStringAsync());
                    }
